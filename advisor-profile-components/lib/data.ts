...
export const advisor = {
  name: 'Priya Rajan',
  initials: 'PR',
  title: 'TBO Gold Advisor · Europe Specialist',
  location: 'Mumbai',
...
export const tripPins: TripPin[] = [
  { id: '1', city: 'Paris', lat: 48.8566, lng: 2.3522, route: 'Paris → Swiss Alps → Rome', duration: '16 days · Family of 4', type: 'Family' },
  { id: '2', city: 'Rome', lat: 41.9028, lng: 12.4964, route: 'Rome · Colosseum & Amalfi day trip', duration: '5 days · Couple', type: 'Couple' },
  { id: '3', city: 'Barcelona', lat: 41.3851, lng: 2.1734, route: 'Barcelona → Amalfi → Santorini', duration: '14 days · Couple', type: 'Couple' },
  { id: '4', city: 'Santorini', lat: 36.3932, lng: 25.4615, route: 'Santorini Honeymoon', duration: '7 days · Couple', type: 'Honeymoon' },
  { id: '5', city: 'Amsterdam', lat: 52.3676, lng: 4.9041, route: 'Amsterdam → Rhine Valley → Vienna', duration: '18 days · Family of 5', type: 'Family' },
  { id: '6', city: 'Vienna', lat: 48.2082, lng: 16.3738, route: 'Vienna & Salzburg', duration: '8 days · Solo', type: 'Solo' },
  { id: '7', city: 'Florence', lat: 43.7696, lng: 11.2558, route: 'Tuscany & Cinque Terre', duration: '12 days · Couple', type: 'Couple' },
  { id: '8', city: 'Prague', lat: 50.0755, lng: 14.4378, route: 'Prague → Budapest', duration: '10 days · Friends group', type: 'Group' },
  { id: '9', city: 'Amalfi', lat: 40.6340, lng: 14.6027, route: 'Amalfi Coast circuit', duration: '6 days · Honeymoon', type: 'Honeymoon' },
  { id: '10', city: 'Zurich', lat: 47.3769, lng: 8.5417, route: 'Swiss Alps & Lakes', duration: '9 days · Family of 4', type: 'Family' },
]
